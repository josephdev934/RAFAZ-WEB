      ...
      <div className="flex flex-col md:flex-row md:flex-wrap justify-center md:justify-between gap-8 md:gap-[100px]">
        ...
        <div data-aos="fade-right" data-aos-delay="100" className="flex-1 md:flex-none">
          ...
          <ul className="flex gap-5 mt-10 flex-wrap">
            {/* Twitter */}
            <a href="https://x.com/rafazweb?t=CQnY7zimhFB6gIxYtOk_5A&s=09">
              <svg
                width="32"
                height="32"
                className="fill-current hover:text-[#473BF0] hover:scale-110 transition-transform duration-300"
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/share/1FxMoCmTpH/">
              <svg
                width="32"
                height="32"
                className="fill-current hover:text-[#473BF0] hover:scale-110 transition-transform duration-300"
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/rafazweb?igsh=MXNhMTlvZzhtNmlqbg==">
              <svg
                width="34"
                height="34"
                className="fill-current hover:text-[#473BF0] hover:scale-110 transition-transform duration-300"
          ...
          >
            <ul className="font-gentium space-y-2">
              {section.links.map((link, lidx) => (
                <li key={lidx} className="hover:text-[#473BF0] transition-colors duration-300">
